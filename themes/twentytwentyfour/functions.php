...
function wp_learn_amend_content( $content ) {
	$additional_content = '<!-- wp:paragraph --><p>Filtered trough <i>the_content</i></p><!--/wp:paragraph -->';
...
function wp_learn_amend_the_excerpt($post_excerpt) {
	$additional_content = '<p>Veerified by Search Engine</p>';
...
// 	$additional_content = '<p>' . $post->post_title . 'Veerified by Search Engine</p>';
// 	$post_excerpt 		= $post_excerpt . $additional_content;

// 	return $post_excerpt;
// }

// add_filter('get_the_excerpt', 'wp_learn_amend_the_excerpt', 11, 2); // esta determina cuantas funciones callback acepta.